...
if(instance_exists(inst)&&duration>=0&&(((tween>=0&&tween<=GMU_ANIM.BOUNCE)&&(ease>=GMU_ANIM.IN&&ease<=GMU_ANIM.IN_OUT))||tween==GMU_ANIM.LINEAR)&&duration>=0){
var proc=0;
var proc_result=0;
var inst_find=noone;
...
inst_result[proc_result]=instance_create(0,0,_gmu_anim);
